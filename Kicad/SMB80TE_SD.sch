...
U 1 1 6188B7C4
P 9050 1550
F 0 "J2" H 8550 2250 50  0000 L CNN
F 1 "Micro_SD_Card_Kit" H 9050 2250 50  0000 L CNN
F 2 "Kicad:AE-microSD-LLCNV" H 10200 1850 50  0001 C CNN
F 3 "http://katalog.we-online.de/em/datasheet/693072010801.pdf" H 9050 1550 50  0001 C CNN
	1    9050 1550
	1    0    0    -1  
$EndComp
NoConn ~ 8150 1350
...
U 1 1 625CD0DA
P 8000 1100
F 0 "#PWR011" H 8000 950 50  0001 C CNN
...
U 1 1 625DAB5A
P 8000 2200
F 0 "#PWR012" H 8000 1950 50  0001 C CNN
...
U 1 1 621A9C99
P 8100 4850
F 0 "#PWR09" H 8100 4600 50  0001 C CNN
...
U 1 1 61A254A8
P 7400 4150
F 0 "U2" H 7400 5039 60  0000 C CNN
F 1 "Arduino_Pro_Mini_5V" H 7400 4933 60  0000 C CNN
F 2 "Kicad:Arduino_Pro_Mini" H 8200 3400 60  0001 C CNN
F 3 "https://www.sparkfun.com/products/11113" H 7600 2950 60  0001 C CNN
	1    7400 4150
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 631763B9
P 10000 2850
F 0 "J3" H 9650 2400 50  0000 L CNN
F 1 "MicroSD Card Adapter" H 9400 2300 50  0000 L CNN
...
NoConn ~ 7600 5050
$Comp
L Interface:Z8420 U1
U 1 1 6418003D
P 3700 3950
F 0 "U1" H 3400 5250 50  0000 C CNN
F 1 "Z8420" H 4000 5250 50  0000 C CNN
F 2 "Package_DIP:DIP-40_W15.24mm_LongPads" H 3700 2550 50  0001 C CNN
F 3 "https://www.zilog.com/appnotes_download.php?FromPage=DirectLink&dn=PS0180&ft=Product%20Specification%20(Data%20Sheet)%20%20&f=YUhSMGNEb3ZMM2QzZHk1NmFXeHZaeTVqYjIwdlpHOWpjeTk2T0RBdmNITXdNVGd3TG5Ca1pnPT0=" H 3650 2350 50  0001 C CNN
	1    3700 3950
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	6250 2850 4200 2850
$Comp
L Interface:Z8420 J1
U 1 1 64187B00
P 1650 3950
F 0 "J1" H 1350 5250 50  0000 C CNN
F 1 "SOCKET" H 1950 5250 50  0000 C CNN
F 2 "Package_DIP:DIP-40_W15.24mm_LongPads" H 1650 2550 50  0001 C CNN
F 3 "https://www.zilog.com/appnotes_download.php?FromPage=DirectLink&dn=PS0180&ft=Product%20Specification%20(Data%20Sheet)%20%20&f=YUhSMGNEb3ZMM2QzZHk1NmFXeHZaeTVqYjIwdlpHOWpjeTk2T0RBdmNITXdNVGd3TG5Ca1pnPT0=" H 1600 2350 50  0001 C CNN
	1    1650 3950
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 642897BE
P 5350 3550
F 0 "LS1" H 5520 3546 50  0000 L CNN
F 1 "Speaker" H 5520 3455 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 5350 3350 50  0001 C CNN
...
U 1 1 621E99AD
P 8200 3550
F 0 "#PWR010" H 8200 3400 50  0001 C CNN
